...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('/unity_image/compressed_d1', Image, self.image_callback)
    ...
    def callback(self, data):
        ...
        if d01_posZ >= 5 and curr_time > 20:
        ...
        print(new_velX, velY)
        calc_odom = (Vector3(new_velX,velY,-0.8*(d01_posZ-10)))
