...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('/unity_image/compressed_d6', Image, self.image_callback)
    ...
    def callback(self, data):
        ...
        if d06_posZ < 2 and dist_56 > 15:            
            ...
            if d06_posZ >= 5 and curr_time > 10:
            ...
            calc_odom = (Vector3(new_velX,velY,-0.8*(d06_posZ-10)))
