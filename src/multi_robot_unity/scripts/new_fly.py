...
def callback(data):
    ...
    calc_odom_d2 = (Vector3(new_velx_d1, new_vely_d1,-5*(d1_posZ-5)))
    calc_odom_d2 = (Vector3(new_velx_d2, new_vely_d2,-5*(d2_posZ-10)))
    calc_odom_d2 = (Vector3(new_velx_d3, new_vely_d3,-5*(d3_posZ-15)))
