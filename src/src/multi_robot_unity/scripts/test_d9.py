...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('/unity_image/compressed_d9', Image, self.image_callback)
    ...
    def callback(self, data):
        ...
        if d09_posZ < 2 and dist_19 > 15:
            ...
            if d09_posZ >= 5 and curr_time > 10:
            ...
            new_velX = velX - repul
            calc_odom = (Vector3(new_velX,velY,-0.8*(d09_posZ-10)))
