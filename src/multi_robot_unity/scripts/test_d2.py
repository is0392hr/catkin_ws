...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('/unity_image/compressed_d2', Image, self.image_callback)
    ...
    def callback(self, data):
        ...
        calc_odom = (Vector3(new_velX, velY,-0.8*(d02_posZ-10)))
